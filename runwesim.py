...
if __name__ == '__main__':
    ...
    eps_din,eps_dout = 0.4,0.0 # The normalized std (second moment divided by the first) of the network
    ...
    graphname  = 'GNull'
    foldername = 'gauss_N400_lam14_tau1_it100_jump5_quant5_sims2000_net10_epsin01_epsout02'
